...
def set_colors(names):
	subs=['Basal', 'Basal-R', 'Health', 'Health-MH0023', 'Health-MH0064', 'Health-MH0169', 'Health-PM0019', 
	'Health-PM0092', 'Health-PM0095', 'Health-PM0233', 'Her2', 'Lum', 'Lum-R', 'LumB', 'Normal']
	
	colors=['red', 'orange', 'brown', '#563916', '#AB3E2C', '#C53824', '#352161',
	 '#7E99A5', '#8B0051', '#90F59F', 'purple', 'blue', 'darkturquoise', 'cyan', 'pink']

	temp=pd.DataFrame(data=colors, index=subs,columns=["color"])
	if len(list(set(names) & set(subs)))==len(names):
		return temp.loc[names].color.to_list()
	else:
		print("random")
		return sns.color_palette("colorblind")[:len(names)]
